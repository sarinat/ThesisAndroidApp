                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    newResAPICallResult = await ValetAPIGroup
                                        .newReservationCall
                                        .call(
                                      resNumPeople:
                                          resNumPeopleCountControllerValue,
                                    ...
                                    if ((newResAPICallResult?.succeeded ??
                                        true)) {
                                      logFirebaseEvent(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          ...
                                          content: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                SizedBox(height: 100,width:100 , child: Image.asset("assets/images/xa.png")),
                                                SizedBox(height: 10,),
                                                Text("Your reservation has been successful. Hope to see you on time!!"),
                                              ],
                                            ),
                                          ),
                                            actions: [
